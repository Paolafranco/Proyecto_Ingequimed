...
namespace Ginecologia_Ingequimed.Controllers
{
    public class CalendariosController : Controller
    {
        ...
        public CalendariosController(MainContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Día,Mes,Año,Hora")] Calendario calendario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Día,Mes,Año,Hora")] Calendario calendario)
        {
            if (id != calendario.Id)
            {
                return NotFound();
